...
define('SUPER_EMAIL', 'saas@supermaxai.com');
define('SUPER_PASSWORD', '$2y$10$ZJMKwG0lIIbTppvR4uuED.DmEhXoSFsfAu4QjTrTU1oLwU0Xs5agW');
//password of super : Jshs-03@M23-we-sks
//link to encrypt the password https://board.support/docs/files/password.php?p=Jshs03#sks
...
define('CLOUD_PUSHER_ID', 2022159);
define('CLOUD_PUSHER_KEY', '9394c7cbb7558678faef');
define('CLOUD_PUSHER_SECRET', 'cdb0895a2bb8e0c865bb');
...
define('CLOUD_SMTP_HOST', 'smtp.sendgrid.net');
define('CLOUD_SMTP_USERNAME', 'apikey');
define('CLOUD_SMTP_PASSWORD', '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');
define('CLOUD_SMTP_PORT', 587);
define('CLOUD_SMTP_SENDER', 'XexLon');
define('CLOUD_SMTP_SENDER_NAME', 'info@supermaxai.com');  

define('CLOUD_DB_NAME', 'hd_nexleon_db');
define('CLOUD_DB_USER', 'root');
define('CLOUD_DB_PASSWORD', '');
// define('CLOUD_DB_USER', 'saas_name');
...
define('SB_CLOUD_PATH', 'C:/wamp64/www/saassupport/');
...
define('SB_CLOUD_BRAND_ICON', CLOUD_URL.'/script/media/nexleon-favicon-n.png');
define('SB_CLOUD_BRAND_ICON_PNG', CLOUD_URL.'/script/media/nexleon-favicon-n.png');
define('SB_CLOUD_BRAND_NAME', 'XTec Global');
define('SB_CLOUD_MANIFEST_URL', 'http://localhost/saassupport/manifest.json');
...
define('ENVATO_PURCHASE_CODE' ,'a5856ff6-0841-4975-bdd2-e4ad72bdb52a');
