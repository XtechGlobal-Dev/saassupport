...
function sb_installation($details, $force = false) {
    ...
    if ($connection_check === true) {
        ...
        $db_respones['ticket_status'] = $connection->query('CREATE TABLE IF NOT EXISTS `ticket_status` (`id` int(11) NOT NULL AUTO_INCREMENT,`name` varchar(50) NOT NULL,`color` varchar(20) NOT NULL,`created_at` timestamp NOT NULL DEFAULT current_timestamp(), PRIMARY KEY (id),FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci');
