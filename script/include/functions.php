...
function sb_installation($details, $force = false) {
    ...
    if ($connection_check === true) {
        ...
        $db_respones['custom_fields'] = $connection->query('CREATE TABLE IF NOT EXISTS `custom_fields` (`id` int(11) NOT NULL AUTO_INCREMENT,`title` varchar(100) NOT NULL,`type` enum("text","textarea","select","checkbox") NOT NULL DEFAULT "text",`required` tinyint(1) NOT NULL DEFAULT 0,`add_to_frontend_form` tinyint(1) NOT NULL DEFAULT 0,`default_value` varchar(255) DEFAULT NULL,`is_active` tinyint(1) NOT NULL DEFAULT 1, `order_no` int(11) NOT NULL DEFAULT 0,`options` text DEFAULT NULL, PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci');
        ...
        $db_respones['sb_tickets'] = $connection->query('CREATE TABLE IF NOT EXISTS `sb_tickets` (`id` int(11) NOT NULL AUTO_INCREMENT,`subject` varchar(255) NOT NULL,`contact_id` int(11) DEFAULT NULL,`contact_name` varchar(100) DEFAULT NULL,`contact_email` varchar(100) DEFAULT NULL,`assigned_to` int(11) DEFAULT NULL,`priority_id` int(11) NOT NULL,`service_id` int(11) DEFAULT NULL,`department_id` int(11) DEFAULT NULL,`tags` varchar(255) DEFAULT NULL, `description` LONGTEXT DEFAULT NULL, `notes` text DEFAULT NULL,`created_by` int(11) DEFAULT NULL,`updated_by` int(11) DEFAULT NULL,`creation_time` timestamp NOT NULL DEFAULT current_timestamp(),`updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),`status_id` int(11) NOT NULL DEFAULT 1,`conversation_id` int(11) DEFAULT NULL,`last_reply` timestamp NULL DEFAULT NULL,FOREIGN KEY (conversation_id) REFERENCES sb_conversations(id) ON DELETE CASCADE,FOREIGN KEY (created_by) REFERENCES sb_users(id) ON DELETE CASCADE,FOREIGN KEY (updated_by) REFERENCES sb_users(id) ON DELETE CASCADE, PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci');
...
function sb_beautify_date($date_string, $is_short = false) {
    ...
    if ($timezone) {
        ...
        return ucfirst(trim(str_replace('00:00', '', $date_string)));
    }
    return $date_string;
}
...
function sb_utc_offset($is_timezone = false) {
    return sb_isset(explode('|', sb_get_setting('timetable-utc', 0)), $is_timezone, $is_timezone ? '' : 0);
}
