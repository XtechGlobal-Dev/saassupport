...
function sb_component_admin()
{
    ...
    $active_areas = [
        "users" =>
            $is_admin ||
            (!$supervisor &&
                sb_get_multi_setting("agents", "agents-users-area")) ||
            ($supervisor && $supervisor["supervisor-users-area"]),
        "settings" =>
            $is_admin ||
            ($supervisor && $supervisor["supervisor-settings-area"]),
        "reports" =>
            ($is_admin &&
                !sb_get_multi_setting("performance", "performance-reports")) ||
            ($supervisor && $supervisor["supervisor-reports-area"]),
        "articles" =>
            ($is_admin &&
                !sb_get_multi_setting("performance", "performance-articles")) ||
            ($supervisor &&
                sb_isset($supervisor, "supervisor-articles-area")) ||
            (!$supervisor &&
                !$is_admin &&
                sb_get_multi_setting("agents", "agents-articles-area")),
        "chatbot" =>
            defined("SB_DIALOGFLOW") &&
            ($is_admin ||
                ($supervisor && $supervisor["supervisor-settings-area"])) &&
            (!$is_cloud || in_array("dialogflow", $cloud_active_apps)),
        "tickets" => $is_admin,
        "dashboard" => $is_admin,
    ];
...
</svg></i><span class="label">Dashboard</span></a></li>
...
</svg></i><span class="label">Inbox</span></a></li>
...
</svg></i><span class="label">Tickets</span></a></li>
                <?php } ?>
...
</svg></i><span class="label">Customers</span></a></li>
...
</svg></i><span class="label">Articles</span></a></li>
                <?php } ?>
...
</svg></i><span class="label">Reports</span></a></li>
                <?php } ?>
...
<path d="M4.69336 15.25H9.69336" stroke="#5F6465" stroke-width="1.5" stroke-linecap="round"/>
</svg></i><span class="label">Settings</span></a></li>
            </ul>
        </nav>
    ...
    <script>
                ...
                <a id="sb-conversations" class="sb-active">
                    <span>
                        ...
                        if ($active_areas["tickets"]) {
                            echo '<a id="sb-tickets"><span>' .
                                sb_("Tickets") .
                                "</span></a>";
                        }
                        if ($active_areas["chatbot"]) {
                            echo '<a id="sb-chatbot"><span>' .
                                sb_("Chatbot") .
                                "</span></a>";
                        }
            ...
            <main class="main-content" id="mainContent">
                <!-- new code update -->
                    <?php // You can set these dynamically from user session or DB


                    $user_name = "Peter Parker"; // Dynamic
                    $user_image = "./path-to-profile.jpg";
                    // Dynamic
