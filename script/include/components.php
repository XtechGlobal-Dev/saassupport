...
id="flexSwitchCheckDefault" style="width: 27px;">
    ...
    <script>
        function updateSlider($tab) {
            ...
            const left = tabOffsetLeft - containerOffsetLeft + $container.scrollLeft(); // ✅ includes scroll
                ...
                $header =
                    '<header>
                            ...
                            <button class="toggle-btn" type="button">
                                ...
                                <a class="sb-btn sb-icon ticket-back-btn sb_btn_new m-0 me-3 d-none" href="' .
                    $ticketUrl .
                    '" >
