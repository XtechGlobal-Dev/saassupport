...
function sb_ajax_execute() {
    ...
    switch ($function) {
        ...
        case 'get-tickets':
            return sb_json_response(sb_get_tickets( sb_post('ticket_status'),sb_post('sorting', ['creation_time', 'DESC']), sb_post('search', ''), sb_post('pagination'), sb_post('extra'), sb_post('ticket_id'), sb_post('category'), sb_post('tag'), sb_post('tags'), sb_post('source'), sb_post('user_id')));
        ...
        case 'get-conversation-count':
            return sb_json_response(get_total_conversations_count($_POST['date_start'], $_POST['date_end']));
        ...
        case 'get-ticket-id-from-conversation-id':
             return sb_json_response(get_ticket_id($_POST['conversation_id']));
        ...
        case 'dialogflow-message':
            return sb_json_response(sb_dialogflow_message(sb_post('conversation_id'), $_POST['message'], sb_post('dialogflow_language'), sb_post('attachments', []), sb_post('event'), sb_post('parameters'), sb_post('project_id'), sb_post('session_id'), sb_post('audio')));
        ...
        case 'dialogflow-smart-reply':
            return sb_json_response(sb_dialogflow_smart_reply($_POST['message'], sb_post('dialogflow_languages'), sb_post('conversation_id')));
