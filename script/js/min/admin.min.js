...
var SBTicket = {
    ...
    */
    ...
    $(document).ready(function () {
        ...
        ticket_edit_box = admin.find('.sb-profile-edit-box');
        ...
        */
        ...
        $(tickets_area).on('click', '.sb-new-ticket', function () {
            profile_edit_box.addClass('sb-new-ticket');
            profile_edit_box.find('.sb-top-bar .sb-ticket span').html(sb_('Add new ticket'));
            profile_edit_box.find('.sb-top-bar .sb-save').html(`<i class="sb-icon-check"></i>${sb_('Add Ticket')}`);
            profile_edit_box.find('input,select,textara').removeClass('sb-error');
