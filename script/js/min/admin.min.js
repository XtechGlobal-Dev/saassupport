                ...
                if (conversation_id != -1) {
                    ...
                    activeUser().getFullConversation(conversation_id, (response) => {
                        ...
                        if (converted == 1) {
                            ...
                            $('#convert-to-ticket span').html('Linked to ticket');
                            document.querySelector('#convert-to-ticket').setAttribute('data-sb-tooltip', 'Linked to ticket');
        ...
        */
        ...
        $(admin).on('click','#link-ticket',function()
        {
            ...
            SBF.ajax({
                ...
                $('#ticket-selector .sb-close').trigger('click');
            });
        });
