                ...
                Object.entries(response.attachments).forEach(([key, value]) => {
                    attachmentsHtml += `<div class="col-md-2 mb-2">
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    <div class="text-center mb-2">
                                                        <img src="${value.file_path}" class="img-thumbnail p-0" style="max-height: 100px;" alt="${value.original_filename}">
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1 text-truncate">
                                                            <div class="text-truncate">${value.original_filename}</div>
        ...
        if (SB_ADMIN_SETTINGS.pusher) {
            ...
            SBPusher.init(() => {
                ...
                SBPusher.event('updates-ticket-comments', (response) => {
                    ...
                    // Debug output
                    console.log('tttttttt', SBTicket.new_comment_count);
                    ...
                    attachmentsHtml += `<div class="col-md-2 mb-2">
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="text-center mb-2">
                                                        <img src="${value.file_path}" class="img-thumbnail p-0" style="max-height: 100px; margin-top:10px;" alt="${value.original_filename}">
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1 text-truncate">
                                                            <div class="text-truncate">${value.original_filename}</div>
