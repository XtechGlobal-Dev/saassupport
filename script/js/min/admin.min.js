    ...
    var SBDashboard = {
        ...
        get: function (onSuccess, ticket_id = false, categories = false, full = true, language = false) {
            ...
            SBF.ajax({
                ...
                const active_usersCtx = ctx2.getContext('2d');
        ...
        populate: function (response) {
            ...
            {
                code += `<tr class=""><td colspan="4" style="text-align: center;"><strong>No Ticket found2</strong></td></tr>`;
            }
            console.log(response,'dddsss',count,code);
