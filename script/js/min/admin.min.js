        ...
        */
        ...
        $(admin).on('mousedown', function (e) {
            ...
            if ($(SBAdmin.open_popup).length) {
                ...
                // if(targetClassList != "sb-filter-btn")
                // {
                //      $('.sb-filter-btn').sbActive(false);  /// removed sb-active class on click outside
                // }
                ...
                if (!popup.is(e.target) && popup.has(e.target).length === 0 && !isSafe) {
                    if (popup.hasClass('sb-popup')) {
                        ...
                        popup.find('ul').sbActive(false);  $('.sb-filter-btn').sbActive(false);  /// removed sb-active class on click outside
