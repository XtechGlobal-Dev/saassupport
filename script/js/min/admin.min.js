    ...
    var SBDashboard = {
        ...
        get: function (onSuccess, ticket_id = false, categories = false, full = true, language = false) {
            ...
            SBReports.getData("users", from, to, (response) => {
                console.log("users in dash >> ",response);
                
                if (response == false) {
                    area.addClass('sb-no-results-active');
                } else {
                    // Chart + DOM updates directly without condition check
                    ...
                    if (ctx) {
                        ...
                        const increase = totalUsers - values[0]; // adjust if needed
        ...
        getRow: function (ticket) {
            if (ticket) {
                const color = ticket.status_color || "#999999";
                const lightBg = this.lightenColor(color, 40);
    ...
    var SBTicket = {
                                            ...
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-danger remove-file" data-index="0">
                                                            <i class="bi bi-x"></i>
                                                        </button>
                                                    </div>
                                                </div>
        ...
        getRow: function (ticket) {
            if (ticket) {
                ...
                return `<tr data-ticket-id="${ticket.id}">
                <td><!--input type="checkbox" /--> #t${ticket.id}</td>
                <td class="sb-td-subject">${ticket.subject}</td>
                <td class="sb-td-tags">${ticket.tags ?? ''}</td>
                <td class="sb-td-department">${ticket.department }</td>
                ...
                case 'dashboard':
                    loadingGlobal();
                        ...
                        SBDashboard.get((response) => {
                            console.log("SBDashboard.get>>",response);
                            //SBDashboard.populate(response);
                            //SBTicket.init = true;
        ...
        */
        ...
        $(settings_area).on('click', '.edit-custom-field', function () {
            ...
            SBF.ajax({
                ...
                document.querySelector('.sb-ticket-custom-fields-edit-box #order input').value = response.order;
        ...
        $("#save-custom-fields").on("click", async function () {
            ...
            //let new_field = (ticket_edit_box.hasClass('sb-ticket-new') ? true : false);
        ...
        $(settings_area).on('click', '.delete-custom-field', async function () 
        {
           try 
           {
                ...
                const message = 'You want to delete this custom field? Related data will be deleted from Tickets as well. This action cannot be undone.';
        ...
        $(ticket_edit_box).on('click', '.sb-save', function () {
            ...
            let ticketData = {...ticketDataPart1, ...ticketDataPart2, description, conversation_id,attachments, customField};
