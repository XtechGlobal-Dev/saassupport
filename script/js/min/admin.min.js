    ...
    var SBDashboard = {
        ...
        get: function (onSuccess, ticket_id = false, categories = false, full = true, language = false) {
            ...
            SBF.ajax({
                ...
                console.log('tt',values1,response[1].resolved_tickets_count,resolvedBeforeLasteWeek,resolvedTicketspercentageIncrease);
    ...
    $(document).ready(function () {
        ...
        */
        ...
        $(header).on('click', ' .sb-admin-nav a', function () {
            ...
            //// change header title dynamically
            $('.sb-area-' + active_admin_area + ' .header-left .title').html(capitalizeFirstLetter(active_admin_area == 'users'? 'Customers & Users' : active_admin_area));
