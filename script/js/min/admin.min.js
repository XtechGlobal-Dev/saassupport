    ...
    var SBDashboard = {
        ...
        get: function (onSuccess, ticket_id = false, categories = false, full = true, language = false) {
            ...
            SBF.ajax({
                ...
                {
                    html += `<li class="d-flex g-3 mb-6">
                        <img src="${this.profile_image}" alt="Chandara" class="avatar" />
                        <div>
                            <div class="head2 mb-2">${this.user_name}</div>
                            <div class="sub_head2 mb-3">${this.message}</div>
                            <small class="text-muted">${this.creation_time}</small>
                        </div>
