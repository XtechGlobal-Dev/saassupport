    ...
    var SBTicket = {
        ...
        getRow: function (ticket) {
            if (ticket) {
                ...
                if (tickets_table.find('th[data-field="department"]').length) 
                {
                    ...
                    ticket.ticket_tags.forEach(tag => {
                        ...
                        const style = `
                            ...
                            margin-right: 5px;
                        `;
                        rowHtml += `<span class="badge badge-tag" style="${style}">${tag.name}</span>`;
                ...
                rowHtml += `<td class="sb-td-contact">${ticket.contact_name ?? 'Guest'}</td>
                <td class="sb-td-status1 no-click status-dropdown">

                <div class="dropdown">
                    <button class="btn btn-sm dropdown-toggle  currentStatusBtn" data-bs-toggle="dropdown" data-id="${ticket.id}" style="background-color: ${SBDashboard.lightenColor(ticket.status_color, 40)};color: ${ticket.status_color}">
                        ${ticket.status_name}
                    </button>
                ...
                <div class="dropdown">
                    <button class="btn btn-sm dropdown-toggle currentPriorityBtn" data-bs-toggle="dropdown" data-id="${ticket.id}" style="background-color: ${SBDashboard.lightenColor(ticket.priority_color, 40)};color: ${ticket.priority_name}">${ticket.priority_name}</button>
