        ...
        getRow: function (ticket) {
            if (ticket) {
                ...
                <td><!--input type="checkbox" /--> 
                    ...
                    ${SBTicket.new_ticket_count[ticket.id] && SBTicket.new_ticket_count[ticket.id].length ?
                        `<span class="sb-notification-counter">${SBTicket.new_ticket_count[ticket.id].length}</span>`
                        : ''}
                </td>
                <td class="sb-td-subject">${ticket.subject}</td>`;
