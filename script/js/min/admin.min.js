    ...
    var SBTicket = {
        ...
        loadCustomFields: async function () {
            try {
                ...
                // const container = ticket_edit_box.find('#ticketCustomFieldsContainer');
                const container = $('.sb-area-ticket-detail #custom-fields');
                let fieldHtml = '';
        ...
        getRow: function (ticket) {
            if (ticket) {
                ...
                <td class="sb-td-status"><span class="span-border" style="color:${ticket.status_color};background: ${status_bg};">${ticket.status_name}</span></td>
                <td class="sb-td-priority"><span class="span-border" style="color:${ticket.priority_color};background: ${priority_bg};">${ticket.priority_name}</span></td>
        ...
        openTicket: async function (ticket_id) {
            ...
            //$('.sb-area-tickets').sbActive(false);
           ...
           // loadingGlobal();
            ...
            await SBF.ajax({
                ...
                document.querySelector('.sb-area-ticket-detail .tc_back .tsubject').innerHTML  = response.subject;
                ...
                document.querySelector('.sb-area-ticket-detail .tc_back .sidepanel .ticket-reporter span').innerHTML = response.contact_name || 'Unassigned';
                ...
                //     tagsHtml += `<span class="badge" style="background-color:${tag.color}; margin-right: 5px;">${tag.name}</span>`;
                // });
               //document.querySelector('.sb-area-ticket-detail .tc_back .sidepanel .tag-badges').innerHTML = tagsHtml;
    ...
    $(document).ready(function () {
        ...
        */
        ...
        $(tickets_area).on('click', '.sb-new-ticket', function () {
            ...
            ticket_edit_box.sbShowLightbox();
            SBTicket.loadCustomFields();


        });

        // Display new user box
        $(tickets_area).on('click', '.ticket-attachments', function () {
        ...
        $(ticket_edit_box).on('click', '.sb-save', function () {
            ...
            let uploadedFiles = ticket_edit_box.find('#uploaded_files').val() ?? null;
