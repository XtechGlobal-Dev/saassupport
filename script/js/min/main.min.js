...
(function ($) {
    ...
    */
    ...
    //     }
    //     $(this).find('img').attr('src', profile_image).attr('data-name', name);
    //     $(this).find('.sb-name').html(name);
    //     console.log("name" + name + " profile_image: " + profile_image);

    //     await showInitials('user-profile');
    //     return this;
    // }
    $.fn.setProfile = async function (name = false, profile_image = false) {
        if (SBF.null(name)) {
        ...
        const profileBlocks = $('.user-profile');
    ...
    */
    ...
    // async function showInitials(className) {
    //     const containers = $('.header-right .' + className);
    //     containers.each(function () {
    //         const container = $(this);
    //         const img = container.find('img');
    //         const name = img.attr("data-name") || "";
    //         console.log('className', className, 'name', name);
    //         // Create initials
    //         const initials = name
    //             .split(" ")
    //             .map(word => word[0])
