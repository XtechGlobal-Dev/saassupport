...
(function ($) {
    ...
    */
    ...
    $.fn.setProfile = function (name = false, profile_image = false) {
        const activeUserName = activeUser() ? activeUser().name : '1';
        ...
        profileBlocks.each(function () {
            ...
            console.log('fn.setProfile',profile_image);
            profile.find('.sb-name').text(activeUserName || 'Unknown User');
            const pro = profile.find(".sb-profile");
            const img = profile.find(".avatar_img");
            const initials = activeUserName.split(" ").map(word => word[0]).join("").substring(0, 2).toUpperCase();
    ...
    */
    ...
    async function showInitials(container, className) {
         console.log('main.min',container);
