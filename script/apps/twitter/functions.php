 ...
 * ==
 *
 * Twitter app. © 2017-2025 board.support. All rights reserved.
 *
...
function sb_twitter_send_message($twitter_id, $message = '', $attachments = []) {
    ...
    if (empty($message_data['text']) && empty($message_data['quick_reply']) && empty($message_data['ctas']) && empty($message_data['attachment']))
        return false;
